...
KTUtil.onDOMContentLoaded(function () {
    console.log("Purchase Document is ready");
    ...
    $.ajax({
        ...
        console.log(data)
        data = data.filter((item) => item.companyDomain == "purchases");
        loadDataTable(data)
    });
});

function loadDataTable(data) {
    dt = $("#DT_purchases").DataTable({
        searchDelay: 500,
        processing: true,
        stateSave: true,
        distroy: true,
                ...
                render: function (data, type, row, settings) {
                    ...
                    return `
                            <div class="d-flex justify-content-center">
                                 <a href="/Ledgers/LedgersList?id=+${data}" class="btn btn-light btn-active-light-primary btn-sm mx-2" data-bs-toggle="tooltip" title="Edit">
