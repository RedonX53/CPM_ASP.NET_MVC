    ...
    dt = $("#kt_datatable_example_1").DataTable({
        ...
        sortable:false,
                render: function (data, type, row, settings) {
                    ...
                    return `
                            <div class="d-flex justify-content-center">
                                 <a href="/Companies/Edit?id=+${data}" class="btn btn-light btn-active-light-primary btn-sm mx-2" data-bs-toggle="tooltip" title="Edit">
                                 ...
                                 <a  onclick=Delete("/Companies/Delete?id=+${data}") class="btn btn-light btn-active-light-danger btn-sm mx-2" data-bs-toggle="tooltip" title="Delete">
            ...
            },
            {
                targets: 2,
                render: function (data, type, row, settings) {
                    return data == 'sales' ? `<span class="badge badge-light-success">${data.toUpperCase()}</span>` : `<span class="badge badge-light-primary">${data.toUpperCase()}</span>`;
                }
            }
        ],
